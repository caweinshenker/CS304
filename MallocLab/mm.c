...
team_t team={
    "Teamn",                                        /* team name */
    "Colin Weinshenker",                                        /* first member full name */
    "caweinshenker@email.wm.edu",                                        /* first member email address*/
...
#define HDRP(bp)       UNSCALED_POINTER_SUB((char *)(bp), WORD_SIZE)                      //line:vm:mm:hdrp
//#define FTRP(bp)       ((char *)(bp) + SIZE(HDRP(bp)) - DSIZE) //line:vm:mm:ftrp
